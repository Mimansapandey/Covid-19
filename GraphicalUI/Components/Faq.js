...
export default function Faq() {
  ...
  const handleFourthAnswer = () => setFourthAnswer('Maharashtra, Tamil Nadu and Delhi has the highest number of cases.');
  ...
  if (!fontsLoaded) {
    ...
    return (
      <ScrollView style={styles.wrapper}>
        ...
        <View style={styles.container}>
          <Text style={styles.bodyTxtBold}>4. Which states have the highest number of cases?</Text>
          <View><Text style={styles.bodyTxt}>{state4 ? "" : "Maharashtra, Tamil Nadu and Delhi has the highest number of cases.."}</Text></View>
          {/* <Button title="Test" onPress={handleAnswer}/> */}
        </View>
