    ...
    return (
      ...
      <DataTable>
        <DataTable.Header>
          ...
          <DataTable.Title>Deceased</DataTable.Title>
        </DataTable.Header>
        ...
        <FlatList
              ...
              renderItem={({ item }) => (
                ...
                <DataTable.Row>
                  ...
                  <DataTable.Cell>{item.confirmed}</DataTable.Cell>
                  <DataTable.Cell>{item.active}</DataTable.Cell>
                  <DataTable.Cell>{item.recovered}</DataTable.Cell>
                  <DataTable.Cell>{item.deaths}</DataTable.Cell>
                </DataTable.Row>
              )}
            />
